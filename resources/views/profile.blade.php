    ...
    <nav>
        ...
        <div class="top-grad">
            <div class="nav-wrapper">
                <a class="left hide-on-med-and-down" style="padding-left: 3em;"><img src="assets/flag.png" height="70%"
                        width="70%"></a>
...
<body>
    ...
    <p id="iduser" hidden> {{$userman->id_users}} </p>


    @if(Session::has('id'))
    <a class="btn-floating btn-small waves-effect waves-light blue" href="#edit_modal"><i class="material-icons"
            style="padding-top: 10%;">edit</i></a>
    @endif

    <!-- PROFILE BANNER -->

    <div id="prof_banner" class="SECT_profile_banner"
        style="background: url(http://static.boredpanda.com/blog/wp-content/uploads/2016/01/crystal-paintings-fb.png">
    </div>


    <!-- POSTS SECTION -->

    <div id="post_profile" class="SECT_post_profile">
        ...
        <div class="row">
            ...
            <div class="col s4">
                <div class="pic_profile">
                    <a class="left hide-on-med-and-down"><img src={{asset(Session::get('profile_photo'))}}></a>
                </div>

                <div><label id="label_name" class="center">{{ $userman->name}}</label></div>
                
                <div><label id="label_career" class="center">{{ $userman->career}}</label></div>
            </div>
            ...
            <div class="col s8">
                <div class="nav-wrapper col s12">
                  @if($userman->followed == 'true')
                    <a id="follow" class="right"><img src="assets/bulldogred.png" height="50%" width="50%"></a>
                    @else
                    <a id="follow" class="right"><img src="assets/bulldog.png" height="50%" width="50%"></a>
                    @endif
                    <label id="number" class="right" style="padding-right: 0.6em;" for="count_bulldog">0</label>
                    <a class="btn-floating btn-large waves-effect waves-light blue" href="#edit_modal"
                        style="position: fixed; z-index: 3000;"><i class="material-icons"
                            style="padding-top: 10%;">add</i></a>
                </div>
                ...
                <div class="col s12 m7 l3">
                    <div class="card small">
                        <div class="card-image">
                            <img class="materialboxed responsive-img" src="assets/1.jpg">
                        </div>
                    </div>
                </div>
                ...
                <div class="col s12 m7 l3">
                    <div class="card small">
                        <div class="card-image">
                            <img class="materialboxed" src="assets/2.jpg">
                        </div>
                    </div>
                </div>
                ...
                <div class="col s12 m7 l3">
                    <div class="card small">
                        <div class="card-image">
                            <img class="materialboxed" src="assets/3.jpg">
                        </div>
                    </div>
                </div>
    ...
    <div class="modal" id="admission_modal">
        <div class="modal-content">
    ...
    <div class="modal" id="alumni_modal">
        <div class="modal-content">
    ...
    <div class="modal" id="academics_modal">
        <div class="modal-content">
    ...
    <div class="modal" id="edit_modal">
        <form id="form_edit" enctype='multipart/form-data'>
            @crsf
            Pishi Nombre:<br>
            <input id="prof_name" class="black-text" type="text" name="prof_name">
            <br>
            Password:<br>
            <input id="prof_passw" class="black-text" type="text" name="prof_passw">
            <br>
            Career:<br>
            <input id="prof_career" class="black-text" type="text" name="prof_career">
            <br><br>
            <input type="submit">
    ...
    $(document).ready(function() {
        ...
        $('#form_edit').submit(function(event) {
            ...
            var check = $('#prof_name').val();

            if (check == "") {
                alert("NO SE HACE COMPA");
            } else {
